...
.. _On the Convergence of Adam and Beyond:
    ...
    argument_parser.add_argument(
        "--amsgrad",
        type=bool,
        help="""whether to use the AMSGrad variant of this algorithm from the paper `On the Convergence of Adam and
Beyond`_""",
        default=False,
    )
    return argument_parser
...
of the squared gradient."""
    ...
    argument_parser.add_argument(
        "--centered",
        type=bool,
        help="""if ``True``, compute the centered RMSProp, the gradient is normalized by an estimation of its
variance""",
        default=False,
    )
    argument_parser.add_argument(
