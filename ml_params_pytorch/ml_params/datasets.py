...
""",
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""[['data_batch_1', 'c99cafc152244af753f735de768cd75f'], ['data_batch_2',
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{'filename': 'batches.meta', 'key': 'label_names', 'md5':
...
""",
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{'filename': 'meta', 'key': 'fine_label_names', 'md5':
...
.. warning::
    ...
    argument_parser.add_argument("--download", type=bool, required=True)
...
def CelebAConfig(argument_parser):
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""[('0B7EVK8r0v71pZjFTYXZWM3FlRnM', '00d2c5bc6d35e252742224ab0c1e8fcb',
...
def FashionMNISTConfig(argument_parser):
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""['T-shirt/top', 'Trouser', 'Pullover', 'Dress', 'Coat', 'Sandal', 'Shirt',
...
Internally, it uses a VideoClips object to handle clip creation."""
    ...
    argument_parser.add_argument("--frame_rate", required=True)
    argument_parser.add_argument("--_video_min_dimension", required=True)
    argument_parser.add_argument("--num_workers", required=True, default=0)
    argument_parser.add_argument("--_precomputed_metadata", required=True, default=0)
    argument_parser.add_argument("--_audio_samples", required=True)
    argument_parser.add_argument("--_video_width", required=True, default=0)
    argument_parser.add_argument("--_video_height", required=True)
    return argument_parser
...
def ImageNetConfig(argument_parser):
 ...
 Attributes:
    ...
    argument_parser.add_argument("--download", type=str)
    return argument_parser
...
def KMNISTConfig(argument_parser):
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""[('http://codh.rois.ac.jp/kmnist/dataset/kmnist/train-images-idx3-ubyte.gz',
...
Internally, it uses a VideoClips object to handle clip creation."""
    ...
    argument_parser.add_argument(
        "--frames_per_clip", type=int, help="number of frames in a clip", required=True
    )
    argument_parser.add_argument(
        "--step_between_clips",
        type=loads,
    ...
    argument_parser.add_argument("--extensions", required=True)
    argument_parser.add_argument("--frame_rate", required=True)
    argument_parser.add_argument("--num_workers", required=True, default=0)
    argument_parser.add_argument("--_video_min_dimension", required=True, default=0)
    argument_parser.add_argument("--_audio_samples", required=True)
    argument_parser.add_argument("--_video_width", required=True, default=0)
    argument_parser.add_argument("--_audio_channels", required=True)
    argument_parser.add_argument("--_precomputed_metadata", required=True, default=0)
    argument_parser.add_argument("--_video_height", required=True, default=0)
    return argument_parser
...
.. note::
  ...
  dataset with non-integral indices/keys, a custom sampler must be provided."""
    argument_parser.add_argument("--root", type=str, required=True)
    argument_parser.add_argument("--transform", type=str)
    argument_parser.add_argument("--target_transform", type=str)
    return argument_parser
...
def MNISTConfig(argument_parser):
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""['0 - zero', '1 - one', '2 - two', '3 - three', '4 - four', '5 - five',
...
def OmniglotConfig(argument_parser):
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{'images_background': '68d2efa1b9178cc56df9314c21c6e718',
...
def PhotoTourConfig(argument_parser):
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{'notredame': 0.4854, 'yosemite': 0.4844, 'liberty': 0.4437,
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{'notredame': 0.1864, 'yosemite': 0.1818, 'liberty': 0.2019,
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{'notredame': 468159, 'yosemite': 633587, 'liberty': 450092,
...
Raises:
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{('train-standard', False): ('train_large_places365standard.tar',
    '67e186b496a84c929568076ed01a8aa1'), ('train-challenge', False): (
    'train_large_places365challenge.tar',
    '605f18e68e510c82b958664ea134545f'), ('val', False): ('val_large.tar',
    '9b71c4993ad89d2d8bcbdc4aef38042f'), ('train-standard', True): (
    'train_256_places365standard.tar', '53ca1c756c3d1e7809517cc47c5561c5'),
    ('train-challenge', True): ('train_256_places365challenge.tar',
    '741915038a5e3471ec7332404dfb64ef'), ('val', True): ('val_256.tar',
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{'standard': ('filelist_places365-standard.tar',
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{'train-standard': ('places365_train_standard.txt',
...
def QMNISTConfig(argument_parser):
    ...
    , '0058f8dd561b90ffdd0f734c6a30e5e4')], 'test': [(
    ...
    , '5b5b05890a5e13444e108efe57b788aa')], 'nist': [(
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{'train': 'train', 'test': 'test', 'test10k': 'test', 'test50k': 'test',
    'nist': 'nist'}""",
    )
    argument_parser.add_argument(
        "--classes",
...
def STL10Config(argument_parser):
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""[['test_X.bin', '7f263ba9f9e0b06b93213547f721ac82'], ['test_y.bin',
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""[['train_X.bin', '918c2871b30a85fa023e0c44e0bee87f'], ['train_y.bin',
...
.. warning::
    ...
    argument_parser.add_argument(
        ...
        type=loads,
        required=True,
        default="""{'train': ['http://ufldl.stanford.edu/housenumbers/train_32x32.mat',
